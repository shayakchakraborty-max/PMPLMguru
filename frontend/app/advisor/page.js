...
const DEMO_SAMPLES = {
  ...
  existing: [
    ...
    { label: "D2C data protection (DPDP)", agent: "cyber_dpdp", sector: "retail", subtype: "E-commerce/D2C",
      ...
      data: {} },
    { label: "D2C marketing (CAC vs LTV)", agent: "marketing_agent", sector: "retail", subtype: "E-commerce/D2C",
      description: "D2C brand burning on ads with CAC above LTV and weak repeat purchase; needs a profitable channel mix and retention plan.",
      data: {} },
    { label: "Scale past the founder (org)", agent: "org_change", sector: "manufacturing", subtype: "Auto Parts",
      description: "Founder-led firm at 60 staff where everything routes through the owner; needs an operating model, clear roles and an OKR cadence.",
      data: { headcount: 60 } },
