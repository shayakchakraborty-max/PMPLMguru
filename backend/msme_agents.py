...
_INDUSTRY_KEYWORDS = {
    ...
    "agro_export":   ["agro", "farm", "mandi", "commodity", "spices", "rice", "basmati", "makhana", "foxnut", "tea", "coffee", "marine", "apeda"],
    ...
    "food_bev":      ["restaurant", "cloud kitchen", "cafe", "bakery", "catering", "tiffin", "packaged food", "ice cream", "beverage", "dairy"],
